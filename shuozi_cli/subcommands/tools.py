"""``shuozi tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'shuozi tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # shuozi tools list [--platform cli]
    ...
    # shuozi tools disable <name...> [--platform cli]
    ...
    # shuozi tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `shuozi tools` runs after you pick a provider that\n"
