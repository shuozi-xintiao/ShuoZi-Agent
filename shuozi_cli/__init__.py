"""
Hermes CLI - Unified command-line interface for ShuoZi Agent.

Provides subcommands for:
- shuozi chat          - Interactive chat (same as ./hermes)
- shuozi gateway       - Run gateway in foreground
- shuozi gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `shuozi setup` on a fresh Pi.
    ...
    shuozi_cli/stdio.py::configure_windows_stdio() runs later from the entry
