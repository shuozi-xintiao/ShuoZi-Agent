...
Invoked by ``shuozi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the ShuoZi Agent board.
...
def _profile_author() -> str:
    """Mirror of ``shuozi_cli.kanban._profile_author``."""
    return (
