...
Entry point: ``shuozi whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``shuozi_cli/main.py``).
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print("  Docs: https://shuozi-agent.nousresearch.com/docs/user-guide/")
