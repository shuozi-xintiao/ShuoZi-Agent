...
Used by ``shuozi profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``shuozi_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the ShuoZi Agent kanban board.
...
Rules:
  ...
  - Never write "ShuoZi Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_shuozi_home())
        else:
