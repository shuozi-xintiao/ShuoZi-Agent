"""
Skills configuration for ShuoZi Agent.
`shuozi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.shuozi/config.yaml under:
...
from shuozi_cli.config import cfg_get, load_config, save_config
from shuozi_cli.colors import Colors, color
from shuozi_cli.platforms import PLATFORMS as _PLATFORMS
