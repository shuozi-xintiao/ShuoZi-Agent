...
Usage:
    shuozi pairing list              # Show all pending + approved users
    shuozi pairing approve <platform> <code>  # Approve a pairing code
    shuozi pairing revoke <platform> <user_id> # Revoke user access
    shuozi pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle shuozi pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: shuozi pairing {list|approve|revoke|clear-pending}")
        print("Run 'shuozi pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.shuozi/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'shuozi pairing list' to see pending codes.\n")
