"""
Single source of truth for provider identity in ShuoZi Agent.
...
SHUOZI_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "qwen-oauth": HermesOverlay(
        ...
        base_url_env_var="SHUOZI_QWEN_BASE_URL",
    ),
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "shuozi", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = SHUOZI_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + shuozi extra
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in SHUOZI_OVERLAYS
    if provider == "bedrock":
