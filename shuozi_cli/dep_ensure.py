...
def _has_shuozi_agent_browser() -> bool:
    ...
    # install.sh installs globally into $SHUOZI_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-HermesHome", str(get_shuozi_home()),
        ]
    else:
