...
from shuozi_cli.dashboard_auth.base import (
    InvalidCodeError,
    InvalidCredentialsError,
    ProviderError,
)
from shuozi_cli.dashboard_auth.cookies import (
    clear_pkce_cookie,
...
from shuozi_cli.dashboard_auth.login_page import render_login_html
...
def _redirect_uri(request: Request) -> str:
    ...
    Three resolution tiers:
      ...
      1. ``SHUOZI_DASHBOARD_PUBLIC_URL`` env var or
    ...
    from shuozi_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
def _prefix(request: Request) -> str:
    ...
    ``shuozi_cli.dashboard_auth.prefix`` for the normalisation rules.
    """
    from shuozi_cli.dashboard_auth.prefix import prefix_from_request
...
async def api_auth_ws_ticket(request: Request):
    ...
    from shuozi_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
