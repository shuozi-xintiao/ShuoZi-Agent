...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("shuozi_cli.config.get_config_path", return_value=config_path), \
             patch("shuozi_cli.config.ensure_shuozi_home"):
    ...
    def test_ensure_shuozi_home_sets_0700(self):
        home = Path(self.tmpdir) / ".hermes"
        with patch("shuozi_cli.config.get_shuozi_home", return_value=home):
