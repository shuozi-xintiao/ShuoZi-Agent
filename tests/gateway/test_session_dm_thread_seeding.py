...
def store(tmp_path, monkeypatch):
    ...
    ~/.shuozi/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at shuozi_state import time, before pytest's SHUOZI_HOME monkeypatch
    fires — the autouse fixture's SHUOZI_HOME override doesn't help here.)
    """
    import shuozi_state
