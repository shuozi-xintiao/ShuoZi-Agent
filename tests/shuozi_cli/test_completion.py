"""Tests for shuozi_cli/completion.py — shell completion script generation."""
...
from shuozi_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
def _make_parser() -> argparse.ArgumentParser:
    """Build a minimal parser that mirrors the real shuozi structure."""
    p = argparse.ArgumentParser(prog="shuozi")
...
class TestGenerateFish:
    def test_disables_file_completion(self):
        ...
        assert "complete -c shuozi -f" in out
...
class TestProfileCompletion:
    ...
    def test_bash_has_profiles_helper(self):
        ...
        assert 'profiles_dir="$HOME/.shuozi/profiles"' in out
    ...
    def test_bash_profile_actions_complete_profile_names(self):
        """After 'shuozi profile use', complete with profile names."""
        out = generate_bash(_make_parser())
    ...
    def test_zsh_has_profiles_helper(self):
        out = generate_zsh(_make_parser())
        assert "_hermes_profiles()" in out
        assert "$HOME/.shuozi/profiles" in out
