"""Tests for the ``shuozi prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from shuozi_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(shuozi_home, memory_text="", user_text=""):
    mem_dir = shuozi_home / "memories"
...
def _seed_skill(shuozi_home, name, description):
    skill_dir = shuozi_home / "skills" / "demo" / name
