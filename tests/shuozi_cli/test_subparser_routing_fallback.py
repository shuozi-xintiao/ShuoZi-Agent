...
The main() function in shuozi_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `shuozi -c model`
...
def _build_parser():
    """Build a minimal replica of the shuozi top-level parser."""
