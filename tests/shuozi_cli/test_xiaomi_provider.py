...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from shuozi_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SHUOZI_OVERLAYS
        overlay = SHUOZI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify shuozi doctor recognizes Xiaomi env vars."""
