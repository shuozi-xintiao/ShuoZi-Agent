"""Tests for the interactive session browser (`shuozi sessions browse`).
...
from shuozi_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """shuozi sessions browse should be parseable."""
