...
class TestSlackNativeSlashes:
    ...
    def test_telegram_parity(self):
        ...
        via_hermes_norm = {_norm(n) for n in _SLACK_VIA_SHUOZI_ONLY}
...
class TestSlackAppManifest:
    """Generated Slack app manifest (used by `shuozi slack manifest`)."""
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from shuozi_cli import commands as commands_mod
        ...
        monkeypatch.setattr(
            "shuozi_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from shuozi_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch shuozi_cli.plugins.get_plugin_commands() to a fixed dict."""
        from shuozi_cli import plugins as _plugins_mod
    ...
    def test_is_gateway_known_command_recognizes_plugin_commands(self, monkeypatch):
        ...
        from shuozi_cli.commands import is_gateway_known_command
