"""Tests for the specifier module + `shuozi kanban specify` CLI surface.
...
from shuozi_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `shuozi kanban …` argparse surface directly."""
