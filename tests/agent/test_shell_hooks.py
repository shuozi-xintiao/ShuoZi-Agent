...
class TestCallbackSubprocess:
    ...
    def test_block_aggregation_through_plugin_manager(self, tmp_path, monkeypatch):
        ...
        from shuozi_cli import plugins
        ...
        monkeypatch.setenv("SHUOZI_ACCEPT_HOOKS", "1")
...
class TestAllowlistConcurrency:
    ...
    def test_save_allowlist_failure_logs_actionable_warning(
        ...
        re-prompt consequence so "shuozi keeps asking" is debuggable."""
        import logging
        monkeypatch.setenv("SHUOZI_HOME", str(tmp_path / "home"))
        monkeypatch.setattr(
    ...
    def test_command_script_path_resolution(self):
        ...
        ``shuozi hooks doctor``'s executability check and silently
