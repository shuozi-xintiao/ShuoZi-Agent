"""ACP tool-call helpers for mapping shuozi tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map shuozi tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a shuozi tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    *,
    ...
    """Create a ToolCallStart event for the given shuozi tool invocation."""
