...
Config: ~/.shuozi/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.shuozi/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_shuozi_home()`` helper (SHUOZI_HOME-aware and
...
RULES_FILE = get_shuozi_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_shuozi_home() / "feishu_comment_pairing.json"
