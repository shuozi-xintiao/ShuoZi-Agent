...
# Ensure SHUOZI_HOME is set for imports that touch it at module level.
os.environ.setdefault("SHUOZI_HOME", os.path.join(os.path.expanduser("~"), ".hermes"))

from shuozi_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "shuozi-agent repo",
            "docs": "https://shuozi-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
