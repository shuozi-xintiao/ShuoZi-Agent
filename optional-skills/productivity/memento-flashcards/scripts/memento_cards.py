...
Data file: $SHUOZI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SHUOZI_HOME = Path(os.environ.get("SHUOZI_HOME", Path.home() / ".hermes"))
DATA_DIR = _SHUOZI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
