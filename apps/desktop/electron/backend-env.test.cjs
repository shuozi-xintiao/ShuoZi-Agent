...
test('desktop backend PATH adds Hermes-managed bins and missing POSIX sane entries', () => {
  ...
  assert.equal(entries[0], '/Users/test/.shuozi/node/bin')
  assert.equal(entries[1], '/Users/test/.shuozi/shuozi-agent/venv/bin')
...
test('buildDesktopBackendEnv extends PYTHONPATH and backend PATH together', () => {
  ...
  assert.equal(env.PYTHONPATH, '/repo/shuozi-agent:/existing/pythonpath')
  assert.ok(env.PATH.startsWith('/Users/test/.shuozi/node/bin:/Users/test/.shuozi/shuozi-agent/venv/bin:'))
