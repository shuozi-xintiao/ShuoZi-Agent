...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'ShuoZi background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ShuoZi backend is older than this desktop build and may not work correctly. Update to align them.',
    updateShuozi: 'Update ShuoZi',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting ShuoZi Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ShuoZi defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ShuoZi follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'ShuoZi checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ShuoZi configuration...',
    ...
    gateway: {
      ...
      intro:
        'ShuoZi Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running ShuoZi backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SHUOZI_DESKTOP_REMOTE_URL and SHUOZI_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private ShuoZi backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote ShuoZi backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'ShuoZi Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ShuoZi ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ShuoZi runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ShuoZi desktop' },
    ...
    shuoziActiveSessions: (version, count) => `ShuoZi ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ShuoZi environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ShuoZi will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ShuoZi...',
    placeholderReconnecting: 'Reconnecting to ShuoZi…',
    ...
    attachUrlDesc: 'ShuoZi will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of ShuoZi can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of ShuoZi is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected ShuoZi backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed ShuoZi from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ShuoZi will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The ShuoZi updater will take over in its own window and reopen ShuoZi when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ShuoZi reconnects automatically when it’s back.',
    applyingClose: 'ShuoZi will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'ShuoZi needs a one-time install',
    ...
    settingUpTitle: 'Setting up ShuoZi Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another ShuoZi CLI or desktop instance is running. Stop any running ShuoZi instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The ShuoZi installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ShuoZi Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ShuoZi is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ShuoZi…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ShuoZi',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ShuoZi at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ShuoZi connects automatically',
      loopback: 'Opens your browser to sign in — ShuoZi connects automatically',
    ...
    authorizeThere: 'Authorize ShuoZi there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ShuoZi there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'ShuoZi inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ShuoZi will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ShuoZi is restarting...',
      askRestart: 'Ask ShuoZi to restart the server',
      lookingRestart: taskId => `ShuoZi is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ShuoZi is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `ShuoZi finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ShuoZi could not restart the server.',
      stillWorking:
        'ShuoZi is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ShuoZi is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'ShuoZi gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.shuozi/config.yaml). ShuoZi won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'ShuoZi needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'ShuoZi needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ShuoZi Desktop to use Save Image.',
    restartToSaveImages: 'Restart ShuoZi Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `shuozi gateway` running?'
    }
  },
