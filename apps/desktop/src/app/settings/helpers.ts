...
export function getNested(obj: ShuoziConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ShuoziConfigRecord, path: string, value: unknown): ShuoziConfigRecord {
...
function personalityOptions(config: ShuoziConfigRecord): string[] {
