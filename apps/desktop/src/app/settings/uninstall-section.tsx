...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The ShuoZi Agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the ShuoZi Agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the ShuoZi Agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the ShuoZi Agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.shuoziDesktop?.uninstall
    if (!bridge) {
      setLoading(false)
      return
    }
