...
import { getShuoziConfigRecord, type ShuoziGateway, saveShuoziConfig } from '@/shuozi'
...
function getServers(config: ShuoziConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveShuoziConfig(nextConfig)
