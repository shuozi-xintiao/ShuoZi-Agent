...
export type ShuoziConfigRecord = Record<string, unknown>
...
export interface ModelOptionProvider {
   ...
   *  the `shuozi model` CLI / onboarding OAuth flow. */
  auth_type?: string
...
export interface ToolProvider {
   ...
   *  CLI `shuozi tools` active-provider detection). */
  is_active: boolean
}
