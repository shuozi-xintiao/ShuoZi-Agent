...
const desktopWindow = window as unknown as { shuoziDesktop?: Window['shuoziDesktop'] }
const initialHermesDesktop = desktopWindow.shuoziDesktop

function installDesktopBridge(partial: Partial<Window['shuoziDesktop']> = {}) {
  desktopWindow.shuoziDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['shuoziDesktop']
}
...
afterEach(() => {
  ...
  if (initialHermesDesktop) {
    desktopWindow.shuoziDesktop = initialHermesDesktop
  } else {
    delete desktopWindow.shuoziDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['shuoziDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['shuoziDesktop']['openExternal'] })
