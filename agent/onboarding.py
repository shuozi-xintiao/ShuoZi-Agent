...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``shuozi claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``shuozi claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "run `shuozi claw cleanup` (renames it to ~/.openclaw.pre-migration — "
