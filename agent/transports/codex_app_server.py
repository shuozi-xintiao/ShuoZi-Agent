...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("SHUOZI_KANBAN_TASK"):
            kanban_db = spawn_env.get("SHUOZI_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "SHUOZI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("SHUOZI_HOME", os.path.expanduser("~/.shuozi")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "shuozi",
        client_title: str = "ShuoZi Agent",
