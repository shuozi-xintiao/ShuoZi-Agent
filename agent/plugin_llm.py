...
Plugins built on ShuoZi Agent often need to make their own LLM calls
...
:class:`~shuozi_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`shuozi_cli.plugins.PluginContext`
