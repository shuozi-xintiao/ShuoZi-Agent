...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Hermes-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `shuozi plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.shuozi/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.shuozi/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.shuozi/skills/ mappából töltődnek be",
