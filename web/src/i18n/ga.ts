...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Hermes (paireacht le `shuozi plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.shuozi/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.shuozi/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.shuozi/skills/",
