...
export const pt: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Hermes (paridade com `shuozi plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.shuozi/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.shuozi/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.shuozi/skills/",
