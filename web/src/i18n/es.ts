...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Hermes (equivalente a `shuozi plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.shuozi/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.shuozi/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.shuozi/skills/",
