...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Hermes (паритет з `shuozi plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.shuozi/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.shuozi/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.shuozi/skills/",
