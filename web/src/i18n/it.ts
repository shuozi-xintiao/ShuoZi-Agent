...
export const it: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Hermes (parità con `shuozi plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.shuozi/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.shuozi/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.shuozi/skills/",
