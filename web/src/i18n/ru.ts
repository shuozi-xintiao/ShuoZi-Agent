...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов Hermes (аналог `shuozi plugins`).",
    ...
    removeConfirm: "Удалить этот плагин из ~/.shuozi/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.shuozi/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.shuozi/skills/",
