...
def auth_json_path():
    """Return the Hermes auth store path, respecting SHUOZI_HOME overrides."""
    return get_shuozi_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`shuozi tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from shuozi_cli.auth import resolve_nous_access_token
