...
the get_anchored_view / get_messages_around primitives in shuozi_state.
...
# Third-party integrations tag their sessions with SHUOZI_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from shuozi_state import DEFAULT_DB_PATH
